...
function Inspector(controller) {
    ...
    ****/
    ...
    changeFileCommand = function(fileIndices, fileState) {
        data.controller.changeFileCommand(data.file_torrent.getId(), fileIndices, fileState);
    },
    ...
    onFilePriorityToggled = function(ev, fileIndices, priority) {
        changeFileCommand(data.file_torrent.getId(), {'priority-'+priority: fileIndices});
    },
